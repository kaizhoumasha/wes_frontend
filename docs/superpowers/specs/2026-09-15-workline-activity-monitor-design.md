...
┌─────────────────────────────────────────────────────────────────────┐
│ 工作线活动监控                                                      │
│ KT16 · 人工拣料 · manual-picking@0.1.0 · 已启用 · AUTO · 刷新时间   │
├────────────────────────────────────────────┬────────────────────────┤
...
- 当前现场绑定示例可展示 `FIVE_RACK → KT16`、`INLET → CNV0301`、`SCAN1～SCAN4 → STATION_SCAN9～STATION_SCAN12`，但值必须来自 WorkLine Scene 响应。
