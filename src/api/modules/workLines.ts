...
const baseWorkLinesApi = createSoftDeleteCrudApi({
...
}) as unknown as SoftDeleteCrudApi<WorkLinesItem, CreateWorkLinesInput, UpdateWorkLinesInput>

export const workLinesApi = {
  ...baseWorkLinesApi,
