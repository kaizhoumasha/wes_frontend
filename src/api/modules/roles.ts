...
export type PermanentResult = ContractResponseData<'/api/v1/admin/roles/{id}/permanent', 'delete'>
export type PermanentPathParams = ContractPathParams<'/api/v1/admin/roles/{id}/permanent', 'delete'>
...
export const rolesApiMethods = {
   ...
   * @endpoint DELETE /api/v1/admin/roles/{id}/permanent
   * @returns alova method instance
   */
  permanent(params: ContractPathParams<'/api/v1/admin/roles/{id}/permanent', 'delete'>, config?: ContractRequestConfig) {
    return contractMethods.delete('/api/v1/admin/roles/{id}/permanent', { params, config })
  }
}
// ==================== AUTO GENERATED END ====================
